...
class Index extends Component
{
    ...
    {
        return view('livewire.dashboard.admin.user.index', ['users' => User::filter(['search' => $this->search, 'filter_role' => $this->filter_role])->latest()->paginate(50)])->layoutData(['title' => 'User Dashboard | Graha Indah']);
    }
